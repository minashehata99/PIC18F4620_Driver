...
# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/mcal_std_types.h" 1
# 13 "MCAL_LAYER/ADC/../../MCAL_LAYER/mcal_std_types.h"
# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/std_libiraries.h" 1
# 11 "MCAL_LAYER/ADC/../../MCAL_LAYER/std_libiraries.h"
...
# 11 "MCAL_LAYER/ADC/../../MCAL_LAYER/std_libiraries.h" 2
...
# 12 "MCAL_LAYER/ADC/../../MCAL_LAYER/std_libiraries.h" 2
...
# 13 "MCAL_LAYER/ADC/../../MCAL_LAYER/std_libiraries.h" 2
# 13 "MCAL_LAYER/ADC/../../MCAL_LAYER/mcal_std_types.h" 2

# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/compiler.h" 1
# 14 "MCAL_LAYER/ADC/../../MCAL_LAYER/compiler.h"
...
# 14 "MCAL_LAYER/ADC/../../MCAL_LAYER/compiler.h" 2
# 14 "MCAL_LAYER/ADC/../../MCAL_LAYER/mcal_std_types.h" 2
...
# 14 "MCAL_LAYER/ADC/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h" 2
# 46 "MCAL_LAYER/ADC/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_LAYER/ADC/../../MCAL_LAYER/interrupt/mcal_internal_interrupt.h" 2
# 145 "MCAL_LAYER/ADC/../../MCAL_LAYER/interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
typedef struct{
    ...
    adc_acquisition_time_t acqusition_time;
...
static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_select_t channel);
...
Std_ReturnType ADC_Init(const adc_config_t *_adc ){
    ...
    if( ((void*)0) == _adc){
        ...
        (PIR1bits.ADIF = 0);
# 57 "MCAL_LAYER/ADC/hal_adc.c"
        ADC_InterruptHandler = _adc->ADC_InterruptHandler;


        if(_adc->result_format == 0x01U){
            (ADCON2bits.ADFM = 1);
        }
        else if(_adc->result_format == 0x00U){
            (ADCON2bits.ADFM = 0);
        }
        else{
            (ADCON2bits.ADFM = 1);
        ...
        if(_adc->voltage_refrence == 0x01U){
            ADCON1bits.VCFG1 = 1;
            ADCON1bits.VCFG0 = 1;
        }
        else if(_adc->voltage_refrence == 0x00U){
            ADCON1bits.VCFG1 = 0;
            ADCON1bits.VCFG0 = 0;
        }
        else{
...
static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_select_t channel){
    switch(channel){
        ...
        case ADC_CHANNEL_AN5: (TRISA |= ((uint8)1 << 0x0)); break;
        case ADC_CHANNEL_AN6: (TRISA |= ((uint8)1 << 0x1)); break;
        case ADC_CHANNEL_AN7: (TRISA |= ((uint8)1 << 0x2)); break;
        case ADC_CHANNEL_AN8: (TRISA |= ((uint8)1 << 0x2)); break;
        case ADC_CHANNEL_AN9: (TRISA |= ((uint8)1 << 0x3)); break;
        case ADC_CHANNEL_AN10: (TRISA |= ((uint8)1 << 0x1)); break;
        case ADC_CHANNEL_AN11: (TRISA |= ((uint8)1 << 0x4)); break;
        case ADC_CHANNEL_AN12: (TRISA |= ((uint8)1 << 0x0)); break;
        default : { }
