...
# 11 "MCAL_LAYER/GPIO/../std_libiraries.h"
...
# 11 "MCAL_LAYER/GPIO/../std_libiraries.h" 2
...
# 12 "MCAL_LAYER/GPIO/../std_libiraries.h" 2
...
# 14 "MCAL_LAYER/GPIO/../compiler.h" 2
    ...
    if( ((void*)0) == _pin_config || _pin_config ->pin >8 -1 ){
        ...
        switch(_pin_config -> direction){
            case GPIO_DIRECTION_OUTPUT :
                (*tris_register[_pin_config -> port] &= ~((uint8)1 << _pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *direction_status){
    uint8 ret =(Std_ReturnType)0x01;
    if( ((void*)0) == _pin_config || _pin_config ->pin >8 -1 || ((void*)0) == direction_status){
        ret=(Std_ReturnType)0x00;
    }
    else{

        *direction_status=((*tris_register[_pin_config -> port]>>_pin_config->pin) & (uint8)1);
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config , logic_t logic){
    ...
    switch(logic){
            case GPIO_LOW :
                (*lat_register[_pin_config -> port] &= ~((uint8)1 << _pin_config->pin));
                break;
            case GPIO_HIGH :
                (*lat_register[_pin_config -> port] |= ((uint8)1 << _pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config , logic_t *logic){
    ...
    if( ((void*)0) == _pin_config || _pin_config ->pin >8 -1 ){
        ...
        *logic=((*port_register[_pin_config -> port]>>_pin_config->pin) & (uint8)1);
    }
    return ret;
}
...
# 169 "MCAL_LAYER/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_direction_initialize( port_index_t port ,uint8 direction){
    uint8 ret =(Std_ReturnType)0x01;
    if( port >5 -1 ){
        ret=(Std_ReturnType)0x00;
...
# 213 "MCAL_LAYER/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_write_logic( port_index_t port , uint8 logic ){
    uint8 ret =(Std_ReturnType)0x01;
    if( port >5 -1 ){
        ret=(Std_ReturnType)0x00;
...
# 234 "MCAL_LAYER/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port , uint8 *logic){
    uint8 ret =(Std_ReturnType)0x01;
