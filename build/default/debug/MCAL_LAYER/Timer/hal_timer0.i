...
# 12 "MCAL_LAYER/Timer/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/Timer/../GPIO/../mcal_std_types.h" 1
# 13 "MCAL_LAYER/Timer/../GPIO/../mcal_std_types.h"
# 1 "MCAL_LAYER/Timer/../GPIO/../std_libiraries.h" 1
# 11 "MCAL_LAYER/Timer/../GPIO/../std_libiraries.h"
...
# 11 "MCAL_LAYER/Timer/../GPIO/../std_libiraries.h" 2
...
# 12 "MCAL_LAYER/Timer/../GPIO/../std_libiraries.h" 2
...
# 14 "MCAL_LAYER/Timer/../GPIO/../compiler.h" 2
...
# 14 "MCAL_LAYER/Timer/hal_timer0.h" 2
...
# 14 "MCAL_LAYER/Timer/../interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_LAYER/Timer/../interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "MCAL_LAYER/Timer/../interrupt/mcal_interrupt_gen_cfg.h"
typedef void (*InterruptHandler)(void);
# 14 "MCAL_LAYER/Timer/../interrupt/mcal_interrupt_cfg.h" 2
# 46 "MCAL_LAYER/Timer/../interrupt/mcal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_LAYER/Timer/../interrupt/mcal_internal_interrupt.h" 2
# 145 "MCAL_LAYER/Timer/../interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
# 52 "MCAL_LAYER/Timer/hal_timer0.h"
    typedef enum {
...
# 9 "MCAL_LAYER/Timer/hal_timer0.c" 2
...
static InterruptHandler Timer0_InterruptHandler = ((void*)0);


static uint16 timer0_preload = 0;
# 28 "MCAL_LAYER/Timer/hal_timer0.c"
Std_ReturnType Timer0_Init(const timer0_t *_timer ){
...
# 58 "MCAL_LAYER/Timer/hal_timer0.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 75 "MCAL_LAYER/Timer/hal_timer0.c"
Std_ReturnType Timer0_DeInit(const timer0_t *_timer ){
Std_ReturnType ret =(Std_ReturnType)0x01;
    if(((void*)0) == _timer){
        ret=(Std_ReturnType)0x00;
...
# 97 "MCAL_LAYER/Timer/hal_timer0.c"
Std_ReturnType Timer0_Write_value(const timer0_t *_timer ,uint16 _value){
Std_ReturnType ret =(Std_ReturnType)0x01;
    if(((void*)0) == _timer){
        ret=(Std_ReturnType)0x00;
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *_timer){
    if(1 == _timer->timer0_mode){
        ...
        (T0CONbits.T0CS = 1);
        if(1 == _timer->timer0_couter_edge_type){(T0CONbits.T0SE = 0); }
        else if(0 == _timer->timer0_couter_edge_type){(T0CONbits.T0SE = 1); }
        else{ }
    }
    else{ }
}
