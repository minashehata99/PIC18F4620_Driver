...
# 13 "MCAL_LAYER/Timer3/hal_timer3.h"
...
# 12 "MCAL_LAYER/Timer3/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/Timer3/../GPIO/../mcal_std_types.h" 1
# 13 "MCAL_LAYER/Timer3/../GPIO/../mcal_std_types.h"
# 1 "MCAL_LAYER/Timer3/../GPIO/../std_libiraries.h" 1
# 11 "MCAL_LAYER/Timer3/../GPIO/../std_libiraries.h"
...
# 11 "MCAL_LAYER/Timer3/../GPIO/../std_libiraries.h" 2
...
# 12 "MCAL_LAYER/Timer3/../GPIO/../std_libiraries.h" 2
...
# 14 "MCAL_LAYER/Timer3/../GPIO/../compiler.h" 2
...
# 12 "MCAL_LAYER/Timer3/../GPIO/hal_gpio.h" 2
...
# 14 "MCAL_LAYER/Timer3/../interrupt/mcal_interrupt_cfg.h"
...
# 46 "MCAL_LAYER/Timer3/../interrupt/mcal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_LAYER/Timer3/../interrupt/mcal_internal_interrupt.h" 2
# 145 "MCAL_LAYER/Timer3/../interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
# 52 "MCAL_LAYER/Timer3/hal_timer3.h"
    typedef struct{
...
# 9 "MCAL_LAYER/Timer3/hal_timer3.c" 2



static InterruptHandler Timer3_InterruptHandler = ((void*)0);

static __attribute__((inline)) void Timer3_Mode_Select(const timer3_t *_timer);
static uint16 timer3_preload = 0;
# 24 "MCAL_LAYER/Timer3/hal_timer3.c"
    Std_ReturnType Timer3_Init(const timer3_t *_timer ){
...
# 53 "MCAL_LAYER/Timer3/hal_timer3.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 69 "MCAL_LAYER/Timer3/hal_timer3.c"
    Std_ReturnType Timer3_DeInit(const timer3_t *_timer ){
    Std_ReturnType ret =(Std_ReturnType)0x01;
    if(((void*)0) == _timer){
        ret=(Std_ReturnType)0x00;
...
# 91 "MCAL_LAYER/Timer3/hal_timer3.c"
    Std_ReturnType Timer3_Write_value(const timer3_t *_timer ,uint16 _value){
    Std_ReturnType ret =(Std_ReturnType)0x01;
    if(((void*)0) == _timer){
        ret=(Std_ReturnType)0x00;
...
# 111 "MCAL_LAYER/Timer3/hal_timer3.c"
    Std_ReturnType Timer3_Read_value(const timer3_t *_timer ,uint16 *_value){
    Std_ReturnType ret =(Std_ReturnType)0x01;
    uint8 l_tmr3l = 0 , ltmr3h = 0;
