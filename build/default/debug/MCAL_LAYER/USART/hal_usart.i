...
# 13 "MCAL_LAYER/USART/../GPIO/../mcal_std_types.h"
# 1 "MCAL_LAYER/USART/../GPIO/../std_libiraries.h" 1
# 11 "MCAL_LAYER/USART/../GPIO/../std_libiraries.h"
...
# 11 "MCAL_LAYER/USART/../GPIO/../std_libiraries.h" 2
...
# 12 "MCAL_LAYER/USART/../GPIO/../std_libiraries.h" 2
...
# 13 "MCAL_LAYER/USART/../GPIO/../std_libiraries.h" 2
# 13 "MCAL_LAYER/USART/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_LAYER/USART/../GPIO/../compiler.h" 1
# 14 "MCAL_LAYER/USART/../GPIO/../compiler.h"
...
# 14 "MCAL_LAYER/USART/../GPIO/../compiler.h" 2
# 14 "MCAL_LAYER/USART/../GPIO/../mcal_std_types.h" 2
...
# 36 "MCAL_LAYER/USART/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0 ,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h" 1
# 14 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_gen_cfg.h"
typedef void (*InterruptHandler)(void);
# 14 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h" 2
# 46 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_internal_interrupt.h" 2
# 145 "MCAL_LAYER/USART/../../MCAL_LAYER/interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
static InterruptHandler ESUART_TX_InterruptHandler = ((void*)0);



static InterruptHandler ESUART_RX_InterruptHandler = ((void*)0);
static InterruptHandler ESUART_Framing_Error_InterruptHandler = ((void*)0);
static InterruptHandler ESUART_Overrun_Error_InterruptHandler = ((void*)0);
...
static void EUSART_Baud_Rate_Calculations(const usart_t *eusart){
    ...
    switch(eusart->baudrate_gen_gonfig){
        case BAUDRATE_ASYN_8BIT_LOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp = ( (8000000UL / (float)eusart->baudrate) / 64.0 ) - 1;
            break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp = ( (8000000UL / (float)eusart->baudrate) / 16.0 ) - 1;
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
            Baud_Rate_Temp = ( (8000000UL / (float)eusart->baudrate) / 4.0 ) - 1;
            break;
...
static void EUSART_ASYNC_TX_Init(const usart_t *eusart){
    if(1 == eusart->usart_tx_cfg.usart_tx_enable){
        TXSTAbits.TXEN = 1;
        if(1 == eusart->usart_tx_cfg.usart_tx_interrupt_enable){
            PIE1bits.TXIE = 1;


        (PIE1bits.TXIE = 1);
        ESUART_TX_InterruptHandler = eusart->EUSART_TxDefaultInterruptHandler;
# 179 "MCAL_LAYER/USART/hal_usart.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);


        }
        else if(0 == eusart->usart_tx_cfg.usart_tx_interrupt_enable){
            PIE1bits.TXIE = 0;
        }
        else{ }
        if(1 == eusart->usart_tx_cfg.usart_tx_9bit_enable){
            TXSTAbits.TX9 = 1;
        }
        else if(0 == eusart->usart_tx_cfg.usart_tx_9bit_enable){
            TXSTAbits.TX9 = 0;
        }
        else{ }
    }
...
static void EUSART_ASYNC_RX_Init(const usart_t *eusart){
    if(1 == eusart->usart_rx_cfg.usart_rx_enable){
        RCSTAbits.CREN = 1;
        if(1 == eusart->usart_rx_cfg.usart_rx_interrupt_enable){
            PIE1bits.RCIE = 1;
...
# 223 "MCAL_LAYER/USART/hal_usart.c"
        ...
        else if(0 == eusart->usart_rx_cfg.usart_rx_interrupt_enable){
            PIE1bits.RCIE = 0;
        }
        else{ }
        if(1 == eusart->usart_rx_cfg.usart_rx_9bit_enable){
            RCSTAbits.RX9 = 1;
        }
        else if(0 == eusart->usart_rx_cfg.usart_rx_9bit_enable){
            RCSTAbits.RX9 = 0;
        }
        else{ }
    }
