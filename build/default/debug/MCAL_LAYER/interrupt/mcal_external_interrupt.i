...
# 112 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
Std_ReturnType Interrupt_INTx_Init(const interrupt_INTx_t *int_obj){
...
# 348 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Edge_Init(const interrupt_INTx_t *int_obj){
Std_ReturnType ret =(Std_ReturnType)0x01;
    if( ((void*)0) == int_obj){
        ret=(Std_ReturnType)0x00;
...
# 383 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Pin_Init(const interrupt_INTx_t *int_obj){
Std_ReturnType ret =(Std_ReturnType)0x01;
    if( ((void*)0) == int_obj){
        ret=(Std_ReturnType)0x00;
...
# 402 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Clear_Flag(const interrupt_INTx_t *int_obj){
Std_ReturnType ret =(Std_ReturnType)0x01;
    if( ((void*)0) == int_obj){
        ret=(Std_ReturnType)0x00;
        ...
        switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0:
                (INTCONbits.INT0IF = 0); break;
            case INTERRUPT_EXTERNAL_INT1:
                (INTCON3bits.INT1IF = 0); break;
            case INTERRUPT_EXTERNAL_INT2:
                (INTCON3bits.INT2IF = 0); break;
            default : ret = (Std_ReturnType)0x00;
        }
    }
    return ret;
